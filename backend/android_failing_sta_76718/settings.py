"""
Django settings for android_failing_sta_76718 project.
...
ROOT_URLCONF = 'android_failing_sta_76718.urls'
...
WSGI_APPLICATION = 'android_failing_sta_76718.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "android_failing_sta_76718 API",
    "DESCRIPTION": "API documentation for android_failing_sta_76718 App",
    "VERSION": "v1",
}
