...
## Project Structure
    ...
    ├── android_failing_sta_76718  # Django project configurations
...
1. Clone this repo and `cd android_failing_sta_76718`
...
2. Clone this repo and `cd android_failing_sta_76718`
